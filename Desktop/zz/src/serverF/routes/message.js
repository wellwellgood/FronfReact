...
router.post("/", upload.single("file"), async (req, res) => {
  ...
  try {
    ...
    const result = await client.query(
      `INSERT INTO messages (sender_username, receiver_username, sender_name, receiver_name, content, file, file_name, time)
      VALUES ($1, $2, $3, $4, $5, $6, $7, $8)
      RETURNING *`,
      [sender_username, receiver_username, sender_name, receiver_name, content || "", file, file_name, time]
    );
